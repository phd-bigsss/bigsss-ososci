...
# Git in context {background-color="#f8f9fa"}
...
github.com/phd-bigsss/bigsss-repo   3. git push
      ↓
phd-bigsss.github.io/bigsss-repo    4. quarto publish gh-pages
```
...
![alt](images/githubinterface.PNG)
---
