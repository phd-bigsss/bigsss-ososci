...
- Quarto is an open-source scientific and technical publishing system built on top of R Markdown and Pandoc. 

- It allows you to create dynamic documents that combine narrative text, code, and output in a single file. 

- Quarto supports multiple programming languages (R, Python, Julia, Observable) and can render to a wide variety of formats (HTML, PDF, Word, Reveal.js slides, and more).
...
![](images/quartoplain.PNG){width="100%" fig-align="center"}

##

![](images/quartohtml.PNG){width="100%" fig-align="center"}

##

![](images/quartopdf.PNG){width="100%" fig-align="center"}
...
## 4: Code for HTML Regression Tables (texreg)
